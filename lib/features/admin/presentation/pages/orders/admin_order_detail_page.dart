...
import '../../bloc/orders/admin_order_detail_bloc.dart';
import '../../bloc/orders/admin_order_detail_event.dart';
import '../../bloc/orders/admin_order_detail_state.dart';
            ...
            Expanded(
              child: BlocListener<AdminOrderDetailBloc, AdminOrderDetailState>(
                ...
                child: OrderDetailContent(
                  ...
                  paymentStatusPill: widget.order.stripePaymentIntentId != null
                      ? PaymentStatusPill(status: widget.order.paymentStatus, createdAt: widget.order.createdAt)
                      : const CodPaymentPill(),
                  showPaymentIntentId: true,
                ),
              ),
            ),
          ],
